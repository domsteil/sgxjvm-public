...
Projects are built using the popular Gradle tool. The build process for an enclave is complex and involves
...
The ``EnclaveApi`` provides access to the framework's functionality. Inside the enclave many ordinary Java APIs
