...
Oblivium is an advanced platform for the development of *oblivious software*, or software whose processing cannot be observed due to the
use of cryptography. Oblivium lets you write *enclavelets*, small pieces of software which run inside Intel SGX protected memory spaces
